		...
		<?php $this->load->view('includes/boxconsulta');  ?>	
			...
			<div class="content">
				<div class="indent">
					...
					<p class="alt-top">Le invitamos a ud. o a su familia, a quedarse por un dÃ­a o por semanas, por viaje de negocios o por alguna conferencia - nuestra atenciÃ³n le harÃ¡ sentirse mejor que en su casa.</p>
					...
					<div class="wrapper line-ver">
						<div class="col-1">
							...
							<ul>
								<li>Televisor gigante 3D en cada habitaciÃ³n</li>
